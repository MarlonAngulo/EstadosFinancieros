...
//Balance general
  ...
  public totalPasivo1: Number = 0;//valor  que no existe en la base de datos por eso queda estatico
  public Patrimonio1: Number = 2500;//valor  que no existe en la base de datos por eso queda estatico
  public totalPasivomasPatri1: Number = 0;//valor  que no existe en la base de datos por eso queda estatico
...
public utAntesIntEimp2: Number = 0;
...
public totalActivoCirculante2: Number = 0;
public activoFijoNeto2: Number = 8500;
public totalActivo2: Number = 0;
...
public totalPasivo2: Number = 0;
public Patrimonio2: Number = 2300;
public totalPasivomasPatri2: Number = 0;
